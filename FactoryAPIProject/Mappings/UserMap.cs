...
namespace FactoryAPIProject.Mappings
{
    public class UserMap : IEntityTypeConfiguration<AppUser>
    {
        public void Configure(EntityTypeBuilder<AppUser> builder)
        {
            ...
            builder.Property(u => u.Address).HasMaxLength(100).IsRequired(false);
            builder.Property(u => u.FullName).HasMaxLength(100).IsRequired(false);
            builder.Property(u => u.PhoneNumber).HasMaxLength(100).IsRequired(false);
            builder.Property(u => u.Gender).HasMaxLength(100).IsRequired(false);
